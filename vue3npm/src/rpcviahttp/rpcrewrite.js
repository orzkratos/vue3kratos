...
function rewrite(codePath) {
    ...
    fs.readFile(codePath, 'utf8', (erx, data) => {
        ...
        const targetImport = "import { executeGrtp, GrtpPromise } from '@/rpcviahttp/rpcviahttp.ts';"
...
// 执行替换的逻辑
// 比如
// 在项目外侧执行: npm run rpcrewrite -- /xxx/src/rpc/rpc_admin_login/admin_login.client.ts
// 就会自动修改这个文件的内容
